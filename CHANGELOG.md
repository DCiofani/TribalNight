...
- _(in corso: **Fase 5 cutover prod**: applica `0000/0003/0004` al Postgres dello stack, wiro var `web` (authenticator@internal, AUTH_DB_URL=postgres@internal, JWT_SECRET) + flip `NEXT_PUBLIC_BACKEND=api`, verifica, spegni Kong/GoTrue/PostgREST/Realtime)_
