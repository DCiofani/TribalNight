      ...
      <div style={{ padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: 18 }}>
          <div style={{ background: '#2A1A11', border: '1px solid #43291A', borderRadius: 16, padding: 22 }}>
            ...
            <svg viewBox="0 0 640 240" style={{ width: '100%', height: 240, marginTop: 8 }}>
              <defs>
              ...
              <path d="M0 200 L80 170 L160 180 L240 120 L320 130 L400 80 L480 70 L560 40 L640 30 L640 240 L0 240 Z" fill="url(#regia-area)" />
              <path d="M0 200 L80 170 L160 180 L240 120 L320 130 L400 80 L480 70 L560 40 L640 30" fill="none" stroke="#D89A3E" strokeWidth="3" />
            </svg>
          </div>
          <div style={{ background: '#2A1A11', border: '1px solid #43291A', borderRadius: 16, padding: 22 }}>
